...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$getOwnPropertyDescriptor = __webpack_require__(163)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(171)('getOwnPropertyDescriptor', function($getOwnPropertyDescriptor){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IObject = __webpack_require__(168)
	  , defined = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(KEY, exec){
	  var $def = __webpack_require__(172)
	    ...
	    , exp  = {};
	  exp[KEY] = exec(fn);
	  $def($def.S + $def.F * __webpack_require__(175)(function(){ fn(1); }), 'Object', exp);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _get = __webpack_require__(162)['default'];

	var _inherits = __webpack_require__(176)['default'];

	var _createClass = __webpack_require__(187)['default'];
		...
		_createClass(Options, [{
			...
			value: function requestPermission() {
				...
				navigator.getUserMedia({ video: true }, function (s) {
					return _this.setState({ access: true });
				}, function (e) {
					return _this.setState({ access: false });
				});
			}
		}, {
			key: 'render',
			value: function render() {
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'span',
						{ className: this.state.access ? 'hidden' : 'link', onClick: function (e) {
								return _this2.requestPermission();
							} },
	...
	_reactDom2['default'].render(_react2['default'].createElement(Options, null), document.getElementById('container'));
